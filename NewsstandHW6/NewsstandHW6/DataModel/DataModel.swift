...
let classmate2: DukePerson = DukePerson(firstName: "Qirui", lastName: "He", whereFrom: "Shenyang, China", gender: .Male, hobbies: ["dancing"], role: .Student, degree: .MS, languages: ["C++", "Python", "Java"], picture: UIImage(imageLiteralResourceName: "qirui"), team: "Newsstand", netid: "jw606", email: "jw606@duke.edu", department: "Pratt School of Engineering", id: "", nextPage: "no")
let classmate3: DukePerson = DukePerson(firstName: "Trieu", lastName: "Duy", whereFrom: "Shenyang, China", gender: .Male, hobbies: ["dancing"], role: .Student, degree: .MS, languages: ["C++", "Python", "Java"], picture: UIImage(imageLiteralResourceName: "duytrieu"), team: "Newsstand", netid: "jw606", email: "jw606@duke.edu", department: "Pratt School of Engineering", id: "", nextPage: "world")
var dukePersons: [DukePerson] = [myself, professor, TA1, TA2, classmate1, classmate2, classmate3]
